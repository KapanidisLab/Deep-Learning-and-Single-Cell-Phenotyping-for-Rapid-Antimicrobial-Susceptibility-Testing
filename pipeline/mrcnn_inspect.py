...
if __name__ == '__main__':
    ...
    WEIGHTSDIR = os.path.join(get_parent_path(1), 'config120210117T1950', 'mask_rcnn_config1.h5')
    ...
    # Data for prediction
    testdir = os.path.join(get_parent_path(1), 'Data', 'Dataset1_15_01_2021', 'Test')
    traindir = os.path.join(get_parent_path(1), 'Data', 'Dataset1_15_01_2021', 'Train')
